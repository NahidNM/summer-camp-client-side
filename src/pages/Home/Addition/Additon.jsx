      ...
      <div className="grid grid-cols-1 gap-5 space-y-2 md:grid-cols-3 md:p-10">
        <div className="text-black shadow-xl md:w-72 card bg-base-100" data-aos="fade-left ">
          ...
          <div className="items-center text-center card-body">
            ...
            <p>
              ...
              professional footballer who most recently played as a forward for
        ...
        <div className="text-black shadow-xl card md:w-72 bg-base-100" data-aos="fade-down">
          ...
          <div className="items-center text-center card-body">
            ...
            <p>
              Shakib Al Hasan is a Bangladeshi cricketer and current captain of
              the Bangladesh national cricket team in Tests and T20Is. According
              to International Cricket Council, he is currently ranked no. 1
              all-rounder in ODI and T20I cricket and is widely considered to be
        ...
        <div className="text-black shadow-xl card md:w-72 bg-base-100" data-aos="fade-right">
          ...
          <div className="items-center text-center card-body">
            ...
            <p>
              Lin Dan is a Chinese former professional badminton player. He is a
              two-time Olympic champion, five-time World champion, as well as a
